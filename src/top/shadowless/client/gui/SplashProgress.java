...
public class SplashProgress {
    ...
    public static void drawSplash(TextureManager tm){
        ...
        if (splash == null){
            splash = new ResourceLocation("mc/splash.png");
        }
    ...
    private static void drawProgress(){
        ...
        ufr.drawString(step , sr .getScaledWidth() - 20 - ufr.getStringWidth(step), sr.getScaledHeight() - 25 , 0xe1e1eFF);
    ...
    private static void resetTexturesState(){
